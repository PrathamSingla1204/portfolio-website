  ...
  return (
    <div className="outer-landing-container">
      <div className="landing-container">
        ...
        <h1 className="h1-styles animation" id={props.mode==='light' ? '' : 'dark'}>Pratham</h1>
      </div>

      <div className="buttons animation">
        <a className="button-link" id={props.mode==='light' ? '' : 'dark'} href="mailto: pratham.singla.762@gmail.com">
